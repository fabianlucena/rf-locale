...
let partial_dirname = path.dirname(url.fileURLToPath(import.meta.url));
if(!partial_dirname.endsWith(path.sep)) {
  partial_dirname += path.sep;
}
const dirname = partial_dirname;
let server;
