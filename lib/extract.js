    ...
    while (options.index < options.end) {
        ...
        case '`': {
            const closer = options.closer,
                ...
                skipCommentDelimiters = options.skipCommentDelimiters;
            ...
            options.index++;
            options = extractSourcesFromCode(code, {...options, closer: char, extract, skipCommentDelimiters, placeHolderOpener, placeHolderCloser});
            options.skipCommentDelimiters = skipCommentDelimiters;
            options.extract = extract;
            options.closer = closer;
            options.index++;
