...
function init() {
  document.getElementById('translation').             addEventListener('onkeypress', translationUpdated);
  document.getElementById('okAndNextButton').         addEventListener('click', updateTranslationAndNext);
  document.getElementById('removeDraftAndNextButton').addEventListener('click', removeDraftAndNext);
  document.getElementById('okButton').                addEventListener('click', updateTranslation);
  document.getElementById('cancelButton').            addEventListener('click', cancelTranslation);
  document.getElementById('saveButton').              addEventListener('click', saveTranslations);
